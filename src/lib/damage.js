...
class Damage {
  ...
  getDamageResult(a, d, move, field = {}, maxOnly = false) {
    ...
    if (getItemBoostType(attacker.item) === move.type) {
      ...
      bpMods.push(0x1199);
      description.attackerItem = attacker.item;
    } else if (((attacker.item === 'Adamant Orb' && attacker.species === 'Dialga') ||
      (attacker.item === 'Lustrous Orb' && attacker.species === 'Palkia') ||
      (attacker.item === 'Griseous Orb' && attacker.species === 'Giratina-O')) &&
